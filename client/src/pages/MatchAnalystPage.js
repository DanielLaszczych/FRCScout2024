        ...
        <Box marginBottom={'25px'} position={'relative'}>
            <IconButton
                ...
                onClick={() => {
                    ...
                    setMultiTeamRTESSData(null);
                }}
                icon={<FaSearch />}
            />
            {multiTeamEventData === null && multiOneValidMatchForms === null && multiTeamRTESSData === null && (
                <React.Fragment>
                    <IconButton
                        position={'absolute'}
                        right={'15px'}
                                        ...
                                        {multiTeamEventData[teamNumber] && (
                                            <React.Fragment>
                                                ...
                                                >
                                                    <Text flex={1 / 3}>
                                                        {roundToTenth(
                                                            multiTeamEventData[teamNumber].offensivePoints.avg
                                                        )}
                                                    </Text>
                                                    <Text flex={1 / 3}>
